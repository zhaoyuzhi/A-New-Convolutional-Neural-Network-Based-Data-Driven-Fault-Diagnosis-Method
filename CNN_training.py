...
x_data = np.zeros([18000,64,64], dtype = np.float32)              #input training_data
y_data = np.ones([18000,2], dtype = np.float32)                   #correct output training_data
x_test = np.zeros([2000,64,64], dtype = np.float32)               #input testing_data
y_test = np.ones([2000,2], dtype = np.float32)                    #correct output testing_data
...
with tf.Session() as sess:
    sess.run(init)
    # train model
    for i in range(2000):                                           #number of iterations:2000*1125=2250000, 36 millon images
        for m in range(1125):                                       #training process using training data 18000 images
